...
const dictJa: I18nDict = {
  ...
  unlock_p1: '🔓 鍵つきの53枚がひらく（推し色・サイバー・ゴシック・和風・顔フレーム）',
...
いつかSNSでtinyCUBEで撮った写真たちに出会えることを、楽しみにしております。`,
  ...
  trial_hint: '🔒 鍵つきのフレームです。このまま撮れますが、斜めに鍵のシールが入ります。',
  ...
  // ⚠️ **カード（btn_make_sheet）と同じ言葉にすること。**
  //    片方だけ変えたら、押した先で名前が変わっていた（2026-08-31）
  sheet_title: '写真をコラージュ',
  ...
  btn_photo: '写真を撮る',
  guide_photo: '📷 を押すと、そのときの画面がそのまま1枚の写真になります。フレームもエフェクトも乗ったまま保存されます。',
...
お願い申し上げます`,
  ...
  guide_step1_title: 'フレームをえらぶ',
  guide_step1_desc: '顔フレームや推し色のフレームから1つ。縦か横かも、ここで決めます。',
  guide_step2_title: '📸 を押して3枚つづけて撮る',
  guide_step2_desc: 'カメラの許可を聞かれたら「許可」を押してください。1・2・3と数えてから撮ります。',
  guide_step3_title: '文字とスタンプで飾って保存',
  guide_step3_desc: '3枚が1枚のシートになります。プリクラ帳にためた写真は、あとから「写真をコラージュ」で好きな組み合わせに組み直せます。',
  ...
  guide_note1: 'フレームの絵は本来 CMCUBE（PC版）のもので、16:9 で描かれています。縦（9:16）で使うと左右が欠けます。それでも使えるようにしてあるので、欠けるものには一覧で印を出しています。',
  ...
  guide_promo_p4: 'フレームは30種。この tinyCUBE のフレームは、そこから来ています',
...
I am looking forward to the day I run into your tinyCUBE shots on social media.`,
  ...
  sheet_title: 'Collage your photos',
...
Thank you.`,
  ...
  guide_step3_desc: 'The three shots become one sheet. Photos saved in your album can be rearranged later with "Collage your photos".',
